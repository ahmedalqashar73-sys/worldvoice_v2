              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ChoiceChip(
                    ...
                    avatar: Icon(_sectionIcon(index), size: 18),
...
class _VoiceRoomsPage extends StatelessWidget {
    ...
    final roomName = await showDialog<String>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: TextField(
          ...
          autofocus: true,
          maxLength: 40,
          decoration: InputDecoration(hintText: labels.roomNameHint),
        ),
        actions: [
          TextButton(
  ...
  void _showTemporaryTokenMessage(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text(
          'Temporary token is only valid for worldvoice_english_lounge.',
        ),
      ),
    );
  }
    ...
    return ListView(
      ...
      children: [
        ...
        _VoiceRoomCard(
          ...
          onTap: () {
            if (_usingTemporaryToken) {
              _showTemporaryTokenMessage(context);
              return;
            }
